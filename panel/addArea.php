...
menuFooter();
topNavigation();
IniContenido("Areás registradas");
?>

<div class="row">
  <div class="col-12">
    <button type="button" class="btn btn-success" onclick="abrirModal()"><i class="fa fa-plus-circle" aria-hidden="true"></i> Crear Nueva Areá</button>
  </div>
</div>
<hr />
<div class="x_content">
  <div class="row">
    <div class="col-sm-12">
      <div class="card-box table-responsive">
        <p class="text-muted font-13 m-b-30"> Listado de areás registradas en InfoBI</p>
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
          <thead>
            <tr>
              <th>ID</th>
              <th>NOMBRE DEL AREÁ</th>
              <th>ACTIVO</th>
              <th>ACCION</th>
            </tr>
          </thead>
  ...
  <div class="modal-dialog modal-sm8">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel2">Areá</h4>
      ...
      <div class="modal-body">
        ...
        <form id="formarea"  >
          <div class="col-sm-6">
            <label for="nom_area" class="form-label">Nombre Areá</label>
            <input type="text" class="form-control" id="nom_area" name="nom_area" autocomplete="off" onKeyUp="this.value=this.value.toUpperCase()">
          </div>
          <div class="col-sm-6">
...
function abrirModal(dataJson) { 
      ...
      if (dataJson != null){
				$("#id").val(dataJson.id);
        $("#nom_area").val(dataJson.nombre_area);
...
var area = {
    id: $("#id").val(),
    nombre_area: $("#nom_area").val(),
    estado: $("#cbEstado").val()
}

$.ajax({
        type:'POST',
        url: './CapaDatos/nuevoArea.php',
        data: area,
        dataType: 'json',
        async: true,
    })
